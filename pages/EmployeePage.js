...
export default class EmployeePage {
  constructor(page) {
    ...
    this.searchInput = page.locator('input[placeholder="Type for hints..."]'); // updated placeholder
    this.searchButton = page.locator('button:has-text("Search")');
    this.editButton = page.locator('button:has-text("Edit")');
    this.deleteButton = page.locator('button:has-text("Delete")');
    this.confirmDeleteButton = page.locator('button:has-text("Yes, Delete")'); // updated confirm button
  }
  ...
  async addEmployee(firstName, lastName, employeeId) {
    ...
    // Wait for the page to update after adding employee
